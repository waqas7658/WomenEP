...
const Chat = () => {
  ...
  const handleSendMessage = (e) => {
    ...
    if (newMessage.trim() && selectedContact) {
      setMessages([...messages, { text: newMessage, senderId: user.id }]);
      sendMessage(newMessage, selectedContact._id); // Pass recipient's ID
      setNewMessage("");
    }
  };
