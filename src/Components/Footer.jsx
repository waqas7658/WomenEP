        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div class=" flex flex-col justify-center items-center">
              <h6 class="mb-4 text-pink-600 text-3xl flex items-center justify-center font-semibold uppercase md:justify-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <h1 class="text-pink-900 lg:text-2xl text-2xl font-semibold leading-none tracking-tighter text-center">
                Welcome to <br />
